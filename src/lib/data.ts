...
export const skillsData: Skill[] = [
  // Machine Learning
  { name: 'PyTorch', percentage: 60, category: 'Machine Learning', icon: 'Flame', iconClasses: 'text-orange-500', color: 'bg-pink-500' },
  { name: 'Hugging Face', percentage: 50, category: 'Machine Learning', icon: 'Smile', iconClasses: 'text-yellow-400', color: 'bg-yellow-300' },

  // Data Science
  { name: 'NumPy', percentage: 70, category: 'Data Science', icon: 'Sigma', iconClasses: 'text-blue-500', color: 'bg-sky-400' },

  // Programming Languages
  { name: 'JavaScript', percentage: 70, category: 'Programming Languages', icon: 'Braces', iconClasses: 'text-yellow-400', color: 'bg-blue-400' },
  { name: 'Python', percentage: 90, category: 'Programming Languages', icon: 'Code2', iconClasses: 'text-green-500', color: 'bg-green-400' },
  { name: 'TypeScript', percentage: 50, category: 'Programming Languages', icon: 'Braces', iconClasses: 'text-blue-500', color: 'bg-cyan-400' },
  
  // Frontend
  { name: 'React', percentage: 60, category: 'Frontend', icon: 'Atom', iconClasses: 'text-sky-500', color: 'bg-violet-500' },
  { name: 'Next.js', percentage: 55, category: 'Frontend', icon: 'Triangle', iconClasses: 'text-foreground dark:text-white', color: 'bg-emerald-400' },
  ...
  // Backend
  { name: 'Node.js', percentage: 70, category: 'Backend', icon: 'BoxSelect', iconClasses: 'text-green-600', color: 'bg-lime-400' },
  { name: 'Express', percentage: 70, category: 'Backend', icon: 'Server', iconClasses: 'text-neutral-400', color: 'bg-teal-400' },

  // Database (New category from image)
  { name: 'MongoDB', percentage: 50, category: 'Database', icon: 'Database', iconClasses: 'text-green-500', color: 'bg-rose-400' },
  { name: 'PostgreSQL', percentage: 70, category: 'Database', icon: 'DatabaseZap', iconClasses: 'text-blue-600', color: 'bg-fuchsia-500' },
];
